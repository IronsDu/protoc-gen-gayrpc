...
{{end}}
    ...
    public:
        ...
        static inline void Install(gayrpc::core::RpcTypeHandleManager::PTR rpcTypeHandleManager,
    ...
    inline void {{$service.Name}}Service::Install(gayrpc::core::RpcTypeHandleManager::PTR rpcTypeHandleManager,
        const {{$service.Name}}Service::PTR& service,
        const UnaryServerInterceptor& inboundInterceptor,
        const UnaryServerInterceptor& outboundInterceptor)
    {
